...
#ifndef LUMEN_DESKTOP_SWIFT_H
#define LUMEN_DESKTOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="lumen_desktop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13lumen_desktop11AppDelegate")
...
SWIFT_CLASS("_TtC13lumen_desktop18ComposerScrollView")
@interface ComposerScrollView : NSScrollView
...
SWIFT_CLASS("_TtC13lumen_desktop16ComposerTextView")
@interface ComposerTextView : NSTextView
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC13lumen_desktop15EveVoiceManager")
@interface EveVoiceManager : NSObject <AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC13lumen_desktop18FaceCaptureSession")
@interface FaceCaptureSession : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface FaceCaptureSession (SWIFT_EXTENSION(lumen_desktop)) <AVCaptureVideoDataOutputSampleBufferDelegate>
